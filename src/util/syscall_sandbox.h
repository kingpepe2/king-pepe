...
#ifndef KINGPEPE_UTIL_SYSCALL_SANDBOX_H
#define KINGPEPE_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during kingpeped initialization if KingPepe Core was compiled
...
#endif // KINGPEPE_UTIL_SYSCALL_SANDBOX_H
