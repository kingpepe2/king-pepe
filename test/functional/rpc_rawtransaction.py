...
class RawTransactionsTest(KingPepeTestFramework):
    ...
    def createrawtransaction_tests(self):
        ...
        assert_raises_rpc_error(-5, "Invalid KingPepe address", self.nodes[0].createrawtransaction, [], {'foo': 0})
    ...
    def sendrawtransaction_testmempoolaccept_tests(self):
        ...
        # Fee rate is 0.00100000 KPEPE/kvB
        ...
        # Fee rate is 0.20000000 KPEPE/kvB
    ...
    def decoderawtransaction_tests(self):
        ...
        assert_equal(decrawtx['vout'][0]['value'], Decimal('1.00000000'))
        # known ambiguous transaction in the chain (see https://github.com/kingpepe/kingpepe/issues/20579)
