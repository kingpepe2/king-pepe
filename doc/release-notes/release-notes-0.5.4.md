KingPepe version 0.5.4 is now available for download at:
http://sourceforge.net/projects/kingpepe/files/KingPepe/kingpepe-0.5.4/
...
http://gitorious.org/kingpepe/kingpeped-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix KingPepe-Qt notifications under Growl 1.3.
Increase required age of KingPepe-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxKingPepe properly when installing KingPepe-Qt over it. (Windows)
