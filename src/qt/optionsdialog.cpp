      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->kingpepeAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->kingpepeAtStartup);
    ...
    ui->kingpepeAtStartup->setToolTip(ui->kingpepeAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->kingpepeAtStartup->setText(ui->kingpepeAtStartup->text().arg(PACKAGE_NAME));

    ui->openKingPepeConfButton->setToolTip(ui->openKingPepeConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new KingPepeUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->kingpepeAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSKPEPEontrols);
...
void OptionsDialog::on_openKingPepeConfButton_clicked()
{
