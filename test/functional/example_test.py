...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the KingPepeTestFramework
    pass


class ExampleTest(KingPepeTestFramework):
    # Each functional test is a subclass of the KingPepeTestFramework class.
    ...
    def custom_method(self):
        ...
        KingPepeTestFramework class so other tests can use it."""
