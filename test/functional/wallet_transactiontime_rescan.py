...
class TransactionTimeRescanTest(KingPepeTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine KPEPE and create transactions
        ...
        # generate some kpepe to create transactions and check blockcount
        ...
        # send 10 kpepe to user's first watch-only address
        self.log.info('Send 10 kpepe to user')
        ...
        # send 5 kpepe to our second watch-only address
        self.log.info('Send 5 kpepe to user')
        ...
        # send 1 kpepe to our third watch-only address
        self.log.info('Send 1 kpepe to user')
