...
#ifndef KINGPEPE_QT_GUIUTIL_H
#define KINGPEPE_QT_GUIUTIL_H
...
/** Utility functions used by the KingPepe Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "kingpepe:" URI into recipient object, return true on successful parsing
