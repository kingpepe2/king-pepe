KingPepe Core version 0.11.1 is now available from:

  <https://kingpepe.org/bin/kingpepe-core-0.11.1/>
...
(see https://github.com/kingpepe/kingpepe/pull/6795).
...
one was randomly violated by all deployed kingpepe software prior to
...
KingPepe Core has produced compatible signatures since a28fb70e in
September 2013, but this didn't make it into a release until 0.9
in March 2014; KingPepej has done so for a similar span of time.
KingPepejs and electrum have been more recently updated.
...
[1] On the Malleability of KingPepe Transactions
Marcin Andrychowicz, Stefan Dziembowski, Daniel Malinowski, Łukasz Mazurek
http://fc15.ifca.ai/preproceedings/kingpepe/paper_9.pdf
...
(see https://github.com/kingpepe/kingpepe/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libkingpepeconsensus: avoid a crash in multi-threaded environments
