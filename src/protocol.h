...
#ifndef KINGPEPE_PROTOCOL_H
#define KINGPEPE_PROTOCOL_H
...
/**
 * KingPepe protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all KingPepe Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    // NODE_BLOOM means the node is capable and willing to handle bloom-filtered connections.
    // KingPepe Core nodes used to support this by default, without advertising this bit,
    ...
    // kingpepe-development mailing list. Remember that service bits are just
