...
By default, kingpeped will dump mempool on shutdown and
...
class MempoolPersistTest(KingPepeTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent kingpeped from writing mempool.dat to disk. Verify that `savemempool` fails")
