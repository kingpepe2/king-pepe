KingPepe Core version 0.9.2.1 is now available from:

  https://kingpepe.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 KPEPE to 0.01 KPEPE
...
- Fix "Start kingpepe on system login"
