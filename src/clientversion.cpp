 ...
 * for both kingpeped and kingpepe-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("KingPepe");
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/kingpepe/bips/blob/master/bip-0014.mediawiki)
 */
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/kingpepe/kingpepe>";
