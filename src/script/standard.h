...
#ifndef KINGPEPE_SCRIPT_STANDARD_H
#define KINGPEPE_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a kingpepe address
 */
...
/**
 * Generate a KingPepe scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // KINGPEPE_SCRIPT_STANDARD_H
