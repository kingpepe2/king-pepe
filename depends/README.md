...
**KingPepe Core's `configure` script by default will ignore the depends output.** In
...
options will be passed to kingpepe's configure. In this case, `--disable-wallet`.
