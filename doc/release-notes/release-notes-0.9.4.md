KingPepe Core version 0.9.4 is now available from:

  https://kingpepe.org/bin/0.9.4/
...
this update is incompatible with the KingPepe system and could lead to consensus
forks.

KingPepe Core released binaries from https://kingpepe.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~kingpepe/+archive/ubuntu/kingpepe
- A third-party or self-compiled KingPepe Core

upgrade to KingPepe Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
