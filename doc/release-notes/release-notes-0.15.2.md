KingPepe Core version *0.15.2* is now available from:

  <https://bitcoincore.org/bin/kingpepe-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in kingpepe-tx (TheBlueMatt)
