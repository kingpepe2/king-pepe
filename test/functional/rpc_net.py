...
class NetTest(KingPepeTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=22094)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 22094)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=22094), {"success": False})
