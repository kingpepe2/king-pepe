KingPepe Core version 0.10.4 is now available from:

  <https://kingpepe.org/bin/kingpepe-core-0.10.4/>
...
- #6953 `43c2789` Split kingpepe-tx into its own package
- #6953 `dfe0d4d` Include kingpepe-tx binary on Debian/Ubuntu
