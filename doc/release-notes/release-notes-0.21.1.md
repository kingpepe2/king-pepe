...
KingPepe Core version 0.21.1 is now available from:

  <https://bitcoincore.org/bin/kingpepe-core-0.21.1/>
...
fungibility of all kingpepes. Spenders will enjoy lower fees and the
...
The addition of taproot-related features to KingPepe Core's wallet is
...
- Technical specifications
  - [BIP340 Schnorr signatures for secp256k1](https://github.com/kingpepe/bips/blob/master/bip-0340.mediawiki) 
  - [BIP341 Taproot: SegWit version 1 spending rules](https://github.com/kingpepe/bips/blob/master/bip-0341.mediawiki)
  - [BIP342 Validation of Taproot scripts](https://github.com/kingpepe/bips/blob/master/bip-0342.mediawiki)

- Popular articles;
  - [Taproot Is Coming: What It Is, and How It Will Benefit KingPepe](https://kingpepemagazine.com/technical/taproot-coming-what-it-and-how-it-will-benefit-kingpepe)
  - [What do Schnorr Signatures Mean for KingPepe?](https://academy.binance.com/en/articles/what-do-schnorr-signatures-mean-for-kingpepe)
...
- Development history overview
  - [Taproot](https://kingpepeops.org/en/topics/taproot/)
  - [Schnorr signatures](https://kingpepeops.org/en/topics/schnorr-signatures/)
  - [Tapscript](https://kingpepeops.org/en/topics/tapscript/)
  - [Soft fork activation](https://kingpepeops.org/en/topics/soft-fork-activation/)

- Other
  - [Questions and answers related to taproot](https://kingpepe.stackexchange.com/questions/tagged/taproot)
...
- Due to [BIP 350](https://github.com/kingpepe/bips/blob/master/bip-0350.mediawiki)
  ...
  (e.g. through [BIP 341](https://github.com/kingpepe/bips/blob/master/bip-0341.mediawiki)).
...
### Documentation
- #21384 add signet to kingpepe.conf documentation (jonatack)
