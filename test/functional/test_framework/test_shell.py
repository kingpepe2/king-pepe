...
class TestShell:
    """Wrapper Class for KingPepeTestFramework.

    The TestShell class extends the KingPepeTestFramework
    ...
    class __TestShell(KingPepeTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by KingPepeTestFramework child class.
            self.num_nodes = 1
