...
"""Example logging KingPepe Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/kingpeped
...
def main(kingpeped_path):
    ...
    b = BPF(text=program, usdt_contexts=[kingpeped_with_usdts])
