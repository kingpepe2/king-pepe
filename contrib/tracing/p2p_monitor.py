...
""" Interactive kingpeped P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for KingPepe Core can enable. It uses BCC
...
def main(kingpeped_path):
    ...
    kingpeped_with_usdts.enable_probe(
