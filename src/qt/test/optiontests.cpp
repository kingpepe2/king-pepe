...
{
    // Test regression https://github.com/kingpepe/kingpepe/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/kingpepe-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/kingpepe-core/gui/pull/568.
    // With fListen=false in ~/.config/KingPepe/KingPepe-Qt.conf and all else left as default,
    // kingpepe-qt should set both -listen and -listenonion to false and start successfully.
