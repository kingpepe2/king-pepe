KingPepe Core version 0.13.2 is now available from:

  <https://kingpepe.org/bin/kingpepe-core-0.13.2/>
...
- #8908 `4a974b2` Update kingpepe-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow kingpepe-tx to create v2 transactions (kpepedrak)
