...
#ifndef KINGPEPE_ARITH_UINT256_H
#define KINGPEPE_ARITH_UINT256_H
...
public:
     ...
     *
     * KingPepe only uses this "compact" format for encoding difficulty
...
#endif // KINGPEPE_ARITH_UINT256_H
