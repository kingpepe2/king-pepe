...
EXPECTED_HOLDER_NAMES = [
    r"Satoshi Nakamoto",
    r"The KingPepe Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a kingpepe source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The KingPepe Core developers'
...
Arguments:
    <file> - A source file in the kingpepe repository.
"""
