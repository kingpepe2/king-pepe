...
#ifndef KINGPEPE_RPC_PROTOCOL_H
#define KINGPEPE_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in kingpeped
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< KingPepe is not connected
