...
#ifndef KINGPEPE_COMPAT_ASSUMPTIONS_H
#define KINGPEPE_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "KingPepe cannot be compiled without assertions."
#endif
...
#endif // KINGPEPE_COMPAT_ASSUMPTIONS_H
