...
This document provides guidelines for internationalization of the KingPepe Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `kingpepe_en.ts` remains unchanged.
