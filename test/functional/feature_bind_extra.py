...
"""
Test starting kingpeped with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(KingPepeTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that kingpeped has bound on "::1" (for RPC) and "::" (for P2P).
