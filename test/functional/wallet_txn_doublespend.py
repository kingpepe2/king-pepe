...
class TxnMallTest(KingPepeTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 KPEPE:
        ...
        # First: use raw transaction API to send 1240 KPEPE to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 KPEPE coin each
        ...
        # Node0's balance should be starting balance, plus 50KPEPE for another
        ...
        # Node0's total balance should be starting balance, plus 100KPEPE for
