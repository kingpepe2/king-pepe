KingPepe Core version 0.16.1 is now available from:

  <https://bitcoincore.org/bin/kingpepe-core-0.16.1/>
...
- #12843 `df38b13` Test starting kingpeped with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure kingpeped processes are cleaned up when tests end (sdaftuar)
