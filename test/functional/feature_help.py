...
"""Verify that starting kingpepe with -h works as expected."""

from test_framework.test_framework import KingPepeTestFramework
from test_framework.util import assert_equal

class HelpTest(KingPepeTestFramework):
    ...
    def run_test(self):
        self.log.info("Start kingpepe with -h for help text")
        ...
        self.log.info("Start kingpepe with -version for version information")
        ...
        self.log.info("Start kingpeped with -fakearg to make sure it does not start")
