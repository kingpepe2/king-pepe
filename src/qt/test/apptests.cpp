...
//! Entry point for KingPepeApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &KingPepeApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for KingPepeGUI tests.
void AppTests::guiTests(KingPepeGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &KingPepeGUI::consoleShown, this, &AppTests::consoleTests);
