...
KingPepe Core version 0.19.1 is now available from:

  <https://bitcoincore.org/bin/kingpepe-core-0.19.1/>
...
From KingPepe Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as KingPepe Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, KingPepe Core does not yet change appearance when
...
- #17488 fix "kingpeped already running" warnings on macOS (fanquake)
