KingPepe-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/kingpepe/files/KingPepe/kingpepe-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the KingPepe
...
New/changed settings (command-line or kingpepe.conf file)
--------------------------------------------------------
