...
{
    BOOST_CHECK(TestSplitHost("www.kingpepecore.org", "www.kingpepecore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.kingpepecore.org]", "www.kingpepecore.org", 0));
    BOOST_CHECK(TestSplitHost("www.kingpepecore.org:80", "www.kingpepecore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.kingpepecore.org]:80", "www.kingpepecore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:22094", "127.0.0.1", 22094));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:22094", "127.0.0.1", 22094));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:22094", "::ffff:127.0.0.1", 22094));
    BOOST_CHECK(TestSplitHost("[::]:22094", "::", 22094));
    BOOST_CHECK(TestSplitHost("::22094", "::22094", 0));
    BOOST_CHECK(TestSplitHost(":22094", "", 22094));
    BOOST_CHECK(TestSplitHost("[]:22094", "", 22094));
    ...
    BOOST_CHECK(TestSplitHost("www.kingpepecore.org:65536", "www.kingpepecore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.kingpepecore.org:0", "www.kingpepecore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.kingpepecore.org:", "www.kingpepecore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:22094", "127.0.0.1:22094"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:22094", "[::]:22094"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
