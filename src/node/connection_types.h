...
#ifndef KINGPEPE_NODE_CONNECTION_TYPES_H
#define KINGPEPE_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/kingpepe-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on KingPepe’s Peer-to-Peer Network")
...
#endif // KINGPEPE_NODE_CONNECTION_TYPES_H
