...
#ifndef KINGPEPE_WALLET_SCRIPTPUBKEYMAN_H
#define KINGPEPE_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The KingPepe Core wallet was originally a collection of unrelated private
...
#endif // KINGPEPE_WALLET_SCRIPTPUBKEYMAN_H
