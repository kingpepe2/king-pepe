...
#ifndef KINGPEPE_TEST_SCRIPTNUM10_H
#define KINGPEPE_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from KingPepe Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // KINGPEPE_TEST_SCRIPTNUM10_H
