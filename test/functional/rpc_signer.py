...
Verify that a kingpeped node can use an external signer command.
...
class RPCSignerTest(KingPepeTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart kingpeped with -signer=<cmd>',
