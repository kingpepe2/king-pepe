...
#ifndef KINGPEPE_QT_KINGPEPEUNITS_H
#define KINGPEPE_QT_KINGPEPEUNITS_H
...
/** KingPepe unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class KingPepeUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit KingPepeUnits(QObject *parent);

    /** KingPepe units.
      @note Source: https://en.kingpepe.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        KPEPE,
        mKPEPE,
